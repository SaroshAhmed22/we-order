...
import sides1 from './img/sides/sides1.jpeg'
...
const Sides = () => {
    ...
    return (
        <div className="mb-5" id="sidesId">
            <h5 className="text-white mt-4">Sides</h5>
            <div className={classes.root} >
                {
                    sidesData.map((sides) => {
                        const { id, item, itemDesc, itemImg, itemPrice } = sides
                        return (
                            <div>
