...
import deesert1 from './img/deesert/deesert1.jpeg'
    ...
    return (
        <div className="mb-5" id="deesertId">
            ...
            <div className={classes.root} >
                {
                    deesertData.map((deesert) => {
                        const { id, item, itemDesc, itemImg, itemPrice } = deesert
                        return (
                            <div>
